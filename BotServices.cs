    ...
    public class BotServices : IBotServices
    {
        public BotServices(IConfiguration configuration, OrchestratorRecognizer dispatcher)
        {
            ...
            SampleQnA = new QnAMaker(new QnAMakerEndpoint
            {
				...
				ShopQnA = new QnAMaker(new QnAMakerEndpoint
            {
                KnowledgeBaseId = configuration["QnAShopKnowledgebaseId"],
                EndpointKey = configuration["QnAShopEndpointKey"],
                Host = configuration["QnAShopEndpointHostName"]
            });
        }
        ...
        public QnAMaker ShopQnA { get; private set; }
